...
const AMBIENT_SOUNDS: Record<string, string> = {
  night_wind: `${base}audio/ambient/forest.wav`,
  room_silence: `${base}audio/ambient/basement.wav`,
  city_street: `${base}audio/ambient/cabin.wav`,
  bus_engine: `${base}audio/ambient/basement.wav`,
  car_engine: `${base}audio/ambient/basement.wav`,
  street: `${base}audio/ambient/cabin.wav`,
  door_open: `${base}audio/ambient/basement.wav`,
  phone_call: `${base}audio/ambient/basement.wav`,
  window: `${base}audio/ambient/forest.wav`,
  wind_high: `${base}audio/ambient/forest.wav`,
  outer_wall: `${base}audio/ambient/forest.wav`,
  neighbor_room: `${base}audio/ambient/basement.wav`,
  stairwell: `${base}audio/ambient/basement.wav`,
  city_noise: `${base}audio/ambient/cabin.wav`,
  unknown_location: `${base}audio/ambient/basement.wav`,
  classmate_flat: `${base}audio/ambient/basement.wav`,
  indoor_silence: `${base}audio/ambient/basement.wav`,
  door_handle: `${base}audio/ambient/basement.wav`,
  neighbor_corridor: `${base}audio/ambient/basement.wav`,
  distant_traffic: `${base}audio/ambient/forest.wav`,
  quiet_office: `${base}audio/ambient/cabin.wav`,
  years_later: `${base}audio/ambient/cabin.wav`,
}
...
const SFX_SOUNDS: Record<string, string> = {
  ...
  'door-knock': `${base}audio/sfx/bad-ending-impact.wav`,
}
